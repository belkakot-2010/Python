...
def draw_walls(x, y, width, color, base_h, hieght):
    ''' рисует стены '''    
    turtle.penup()
...
def draw_roof(x, y, width, hieght, color, base_h, walls_h, walls_w, roof_y):
    ''' рисует крышу '''
    turtle.penup()
